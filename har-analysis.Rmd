...
Now, to run through the RandomForest algorithm, the data in the "test" set must be of the same type.
...
testing <- rbind(datTraining[2, -58] , testing) #note row 2 does not mean anything, this will be removed right.. now:
testing <- testing[-1,]
```
